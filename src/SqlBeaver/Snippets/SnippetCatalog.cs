    ...
    public static class SnippetCatalog
    {
        ...
        private static IReadOnlyList<SnippetDefinition> BuildDefaults()
        {
            ...
            return new List<SnippetDefinition>
            {
                ...
                S("jn",    "INNER JOIN",              "INNER JOIN ${1:tabela}$ ON $0$"),
                S("lj",    "LEFT JOIN",               "LEFT JOIN ${1:tabela}$ ON $0$"),
                S("rj",    "RIGHT JOIN",              "RIGHT JOIN ${1:tabela}$ ON $0$"),
                S("fj",    "FULL OUTER JOIN",         "FULL OUTER JOIN ${1:tabela}$ ON $0$"),
                S("iit",   "INSERT INTO",             "INSERT INTO ${1:tabela}$ (${2:colunas}$) VALUES (${3:valores}$)$0$"),
                S("ut",    "UPDATE SET WHERE",        "UPDATE ${1:tabela}$ SET ${2:coluna = valor}$ WHERE ${3:condicao}$$0$"),
