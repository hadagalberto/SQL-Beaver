...
1. Pintar a ABA literal não tem API pública no shell do VS/SSMS — entregue como faixa colorida no topo
   do editor (mesma informação, sempre visível). Revisitar se o SSMS expuser API.
